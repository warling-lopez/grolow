...
export default function ContactSection() {
  ...
  return (
    <section
      id="contacto"
      className="w-full py-32 px-6 bg-[#050505] border-t border-white/[.05]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <h2
              className="font-extrabold text-5xl md:text-6xl leading-[1] tracking-tighter text-white mb-6 uppercase"
              style={{ fontFamily: "'Syne', sans-serif" }}>
              tener <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-grolow-cyan to-white/80 italic">
        ...
        <form
          ...
          <div className="flex flex-col gap-4">
            ...
            <select
              ...
              <option value="landing" className="bg-[#080808]">
                Landing Page de conversión
              </option>
              <option value="store" className="bg-[#080808]">
                Tienda online → WhatsApp
              </option>
              <option value="service" className="bg-[#080808]">
                Web de servicios / citas
              </option>
